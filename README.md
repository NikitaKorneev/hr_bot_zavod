...
## Описание проекта
**HR Telegram Bot для завода готовой еды** — это корпоративное решение для автоматизации HR-коммуникаций и работы с запросами сотрудников через удобный Telegram-бот.
В проект входит:
